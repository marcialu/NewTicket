sap.ui.define([
	...
	return BaseObject.extend("NewTicket.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias NewTicket.model.ListSelector
		 */
		 ...
		 * @return {NewTicket.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
